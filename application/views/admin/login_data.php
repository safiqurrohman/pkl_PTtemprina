...
<head>
  ...
  <link rel="icon" href="<?php echo base_url('assets/foto/logo/pt_temprina.png'); ?>" type="image/png">
  ...
  <div class="login-box">
    <div class="login-logo ">
      <a href="<?php echo base_url(); ?>">
        <b style="color: white; font-size:28px;">
          <?php
    ...
    <div class="card">
      <div class="card-header bg-info">
        <h4><i class="fas fa-sign-in-alt"></i>Sign in to your account!!</h4>
      </div>
